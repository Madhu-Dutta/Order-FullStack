...
CREATE TABLE [dbo].[tmp_ms_xx_Customer] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Customer1] PRIMARY KEY CLUSTERED ([CustID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Customer])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Customer] ([CustID], [FullName], [City], [Country], [State], [PostCode], [SegID], [Region])
        SELECT   [CustID],
                 [FullName],
                 [City],
                 [Country],
